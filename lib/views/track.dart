...
class _TrackScreenState extends State<TrackScreen> {
  ...
  final endHours = DateTime(
    2000,
    1,
    1,
    locator<UserViewModel>().user.endTime!.hour,
    locator<UserViewModel>().user.endTime!.minute,
  );
  final startHours = DateTime(
    2000,
    1,
    1,
    locator<UserViewModel>().user.startTime!.hour,
    locator<UserViewModel>().user.startTime!.minute,
  );
  ...
  List<TrackData> averageForMonth(List<TrackData> data) {
    ...
    for (int i = 0; i < data.length; i += daysPerGroup) {
      ...
      for (final day in group) {
        ...
        final dailyOvertime = (dailyHours - idealHours).clamp(
          0,
          double.infinity,
        );
      ...
      monthAverages.add(
        TrackData(
          ...
          group.map((e) => e.productivityScore).reduce((a, b) => a + b) /
              group.length,
          (group.map((e) => e.taskSwitches).reduce((a, b) => a + b) /
                  group.length)
              .round(),
          weeklyOvertime,
        ),
                    ...
                    child: Wrap(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () => setState(() {
                            trackView = 'lastWeek';
                            displayingTrackData = filterByDays(
                              trackDataList,
                              7,
                            );
                          }),
                        ...
                        GestureDetector(
                          onTap: () => setState(() {
                            trackView = 'lastMonth';
                            setState(() {
                              displayingTrackData = averageForMonth(
                                trackDataList,
                              );
                            });
                          }),
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: trackView == 'lastThreeMonths'
                                  ? Color(0xFFDB863B)
                                  : Colors.white,
                              borderRadius: BorderRadius.circular(16),
                            ),
                                ...
                                bottomTitles: AxisTitles(
                                  sideTitles: SideTitles(
                                    ...
                                    getTitlesWidget: (value, meta) {
                                      ...
                                      if (index < 0 ||
                                          index >= displayingTrackData.length)
                                        return const SizedBox.shrink();
                                      final date =
                                          displayingTrackData[index].date;
                                    ...
                                    d.taskHours.forEach((name, hours) {
                                      ...
                                      stacks.add(
                                        BarChartRodStackItem(
                                          ...
                                          toY,
                                          categoryColors[name] ??
                                              graphColors[categoryColors
                                                          .length >=
                                                      20
                                                  ? 0
                                                  : categoryColors.length +
                                                        1 % graphColors.length],
                                        ),
                                      );
                                      fromY = toY;
                                    });
                  ...
                  Container(
                    ...
                    child: Wrap(
                      ...
                      children: displayingTrackData.map((trackItem) {
                        return UserStat(
                          date: trackItem.date,
                          statValue: trackItem.productivityScore,
                          data: trackItem,
                          trackView: trackView,
                        );
                      }).toList(),
                  ...
                  Container(
                    ...
                    child: LineChart(
                      LineChartData(
                        ...
                        lineBarsData: [
                          LineChartBarData(
                            spots: displayingTrackData.asMap().entries.map((
                              trackItem,
                            ) {
                  ...
                  Container(
                    ...
                    child: BarChart(
                      BarChartData(
                        ...
                        borderData: FlBorderData(show: false),
                        barGroups: displayingTrackData.asMap().entries.map((
                          trackItem,
                        ) {
                          ...
                          double overtimeHours =
                              track.overtime == null || trackView == "lastWeek"
                              ? track.taskHours.values.reduce((a, b) => a + b) -
                                    idealHours
                              : track.overtime!;
                          if (overtimeHours < 0) {
                            overtimeHours = 0;
