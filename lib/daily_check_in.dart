...
class _DailyCheckInState extends State<DailyCheckIn> {
  ...
  final List<Tag> availableTags = [
    ...
    Tag(name: "Anxious", category: "work_life_balance", value: -1),
    Tag(name: "Satisfied", category: "work_life_balance", value: 1),
    Tag(name: "Burnt Out", category: "work_life_balance", value: -1),
    Tag(name: "Connected", category: "isolation", value: 1),
    Tag(name: "Lonely", category: "isolation", value: -1),
    Tag(name: "Supported", category: "isolation", value: 1),
    Tag(name: "Detached", category: "isolation", value: -1),
  ];
